...
class DustrialDemoimport {
    ...
    public function johanspond_import_files() {
        return array(
            ...
            array(
                ...
                'import_notice'                => __( 'Are you sure? you want to setup home as a front page ?', 'dustrial' ),
            ),
        );
    }
    ...
    */
    public function johanspond_oneclick_admin_page( $default_settings ) {
        ...
        $default_settings['page_title']  = esc_html__( 'Install Demos', 'dustrial' );
        $default_settings['menu_title']  = esc_html__( 'Install Demos', 'dustrial' );
